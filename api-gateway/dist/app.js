...
app.post('/api/auth/register', async (req, res) => {
    ...
    try {
        ...
        res.status(((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) || 500).json(((_b = error.response) === null || _b === void 0 ? void 0 : _b.data) || { error: 'Authentication service unavailable' });
    }
});
/**
 * @swagger
...
app.get('/api/products', async (req, res) => {
    ...
    try {
        ...
        res.status(((_a = error.response) === null || _a === void 0 ? void 0 : _a.status) || 500).json(((_b = error.response) === null || _b === void 0 ? void 0 : _b.data) || { error: 'Product service unavailable' });
    }
});
/**
 * @swagger
